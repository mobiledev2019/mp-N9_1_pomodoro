package com.demo.pomodoro.activity.todo.shortbreakduration;
...
public class ShortBreakActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = Integer.parseInt(intent.getStringExtra(Constant.ID_SHORT_DONE));
        utils = new SharedPreferenceUtils(this);
        selectedShort = utils.getStringValue(Constant.KEY_POMO_SHORT, getString(R.string._5m));
        TIME_DOWN = 5 * 60000;
        if (selectedShort.equals(getString(R.string._2m))) {
            TIME_DOWN = 2 * 60000;
            minCountdown = "02:00";
        }
        if (selectedShort.equals(getString(R.string._5m))) {
            TIME_DOWN = 5 * 60000;
            minCountdown = "05:00";
        }
        if (selectedShort.equals(getString(R.string._10m))) {
            TIME_DOWN = 10 * 60000;
            minCountdown = "10:00";
        }
        if (minCountdown.isEmpty()) {
            txtTimer.setText("05:00");
        } else {
    ...
    @OnClick({R.id.img_back, R.id.btn_start, R.id.btn_stop, R.id.btn_pause, R.id.btn_complete})
        ...
        switch (view.getId()) {
            case R.id.img_back:
                ...
                builder.setNegativeButton(R.string.leave, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        PomodoroDb db = new PomodoroDb(ShortBreakActivity.this);
                        ...
                        Intent intent = new Intent(ShortBreakActivity.this, HomeActivity.class);
